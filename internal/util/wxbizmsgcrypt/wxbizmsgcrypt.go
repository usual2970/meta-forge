...
func (wx *XmlProcessor) parse(src_data []byte) (*WXBizMsg4Recv, *CryptError) {
...
func (wx *XmlProcessor) serialize(msg4_send *WXBizMsg4Send) ([]byte, *CryptError) {
...
func (wx *WXBizMsgCrypt) VerifyURL(msg_signature, timestamp, nonce, echostr string) ([]byte, error) {
...
func (wx *WXBizMsgCrypt) DecryptMsg(msg_signature, timestamp, nonce string, post_data []byte) ([]byte, error) {
